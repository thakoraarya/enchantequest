...
const Links = () => {
  return (
    <div className="flex justify-center px-10 w-min h-auto py-3 gap-x-8 bg-zinc-900 bg-opacity-25 rounded-full border-2 border-stone-900 backdrop-blur-[12.10px] items-center gap-6">
      <a
        href="https://www.figma.com/file/NJAmGpalxDSyaEakL0hppa/hackathons?type=design&node-id=448-5&mode=design"
        target={"_blank"}
        rel="noreferrer"
