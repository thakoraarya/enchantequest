        ...
        <>
            <section className={'flex justify-between xl:px-24 lg:px-16 md:px-10 px-8 xl:pt-[7.06rem] lg:pt-[5rem] md:pt-[4rem] pt-[3rem] h-full w-full relative overflow-y-hidden overflow-x-hidden'}>
                ...
                <div className='w-full ml-4 min-w-[30rem] h-full relative'>
                    {/*first card*/}
                    <div
                        className="xl:w-64 lg:w-56 md:w-32 w-28  absolute top-0 xl:right-40 lg:right-0 h-auto flex flex-col items-start p-2 bg-[#1A1A1A] bg-opacity-30 rounded-xl border-2 border-stone-900 backdrop-blur-[11.70px]  justify-start  gap-2">
                        <div className="text-neutral-200 xl:text-lg lg:text-md md:text-base text-sm font-normal font-flex leading-relaxed">01
                        </div>
                        <div
                            className="text-neutral-200 xl:text-lg lg:text-md md:text-base text-sm text-left font-normal font-flex leading-relaxed">Engage
                    ...
                    {/*second card*/}
                    <div
                        className="xl:w-64 lg:w-56 md:w-32 w-28 absolute xl:top-72 lg:top-40 left-0 h-auto flex flex-col items-start p-2 bg-[#1A1A1A] bg-opacity-30 rounded-xl border-2 border-stone-900 backdrop-blur-[11.70px]  justify-start  gap-2">
                        <div className="text-neutral-200 xl:text-lg lg:text-md md:text-base text-sm font-normal font-flex leading-relaxed">02
                        </div>
                        <div
                            className=" text-neutral-200 xl:text-lg lg:text-md md:text-base text-sm text-left font-normal font-flex leading-relaxed">
                    ...
                    {/*third card*/}
                    <div
                        className="max-w-[18rem] w-auto min-w-[15.6rem] absolute bottom-[7rem] right-0 h-auto flex flex-col items-start p-2 bg-[#1A1A1A] bg-opacity-30 rounded-xl border-2 border-stone-900 backdrop-blur-[11.70px]  justify-start  gap-2">
                        <div className="text-neutral-200 xl:text-lg lg:text-md md:text-base text-sm font-normal font-flex leading-relaxed">03
                        </div>
                        <div
                            className=' text-neutral-200 xl:text-lg lg:text-md md:text-base text-sm text-left font-normal font-flex leading-relaxed'>Save
