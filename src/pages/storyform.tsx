  ...
  return !loading ? (
    <>
      <section className="bg-bgblob bg-gray800 h-screen flex flex-col-reverse justify-start items-center gap-y-9 w-full p-4">
        <div className={` relative ${loadingStory ? 'overflow-y-hidden' : 'overflow-y-scrol'} w-full h-full p-5 flex flex-col items-center justify-between gap-y-3 border-2 border-gray700 bg-gray700/40 rounded-[2.75rem]`}>
